package com.example.a02travel.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COl_USER_ID = "emailUsr_htl";
    public static final String COL_NM_HOTEL = "nm_hotel";
    public static final String COL_TIPE_KASUR = "tipe_kasur";
    public static final String COL_TGL_CI = "tgl_ci";
    public static final String COL_TGL_CO = "tgl_co";
    public static final String COL_TTL_KMR = "total_kamar";
    public static final String COL_TOTAL_HRG = "total_harga";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_BOOK + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                ...
                + COL_ANAK + " TEXT)");
        db.execSQL("create table " + TABLE_HOTEL + " (" + COl_USER_ID + " TEXT, "+COL_ID_HOTEL + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_NM_HOTEL +
                " TEXT, "+ COL_TGL_CI + " TEXT,"+ COL_TIPE_KASUR + " TEXT, " + COL_TGL_CO + " TEXT, " + COL_TTL_KMR + " TEXT, " + COL_TOTAL_HRG + " TEXT)");
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('dahni@geniuscodeparty.com','dahni','Dahni Eko Setiawan');");
    }
